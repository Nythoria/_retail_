	...
	["profiles"] = {
		["Default"] = {
			["runOnce"] = {
				...
				["cleanupAnyPriorityVersionTypoes_20200124"] = true,
			...
			["packs"] = {
				...
				["Unholy"] = {
					...
					["lists"] = {
						...
						["aoe_burst"] = {
							{
								["enabled"] = true,
								["criteria"] = "runic_power.deficit < ( 10 + death_knight.fwounded_targets * 3 ) & death_knight.fwounded_targets < 6 & ! variable.pooling_for_gargoyle",
								["action"] = "epidemic",
							}, -- [1]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "! death_knight.fwounded_targets & ! variable.pooling_for_gargoyle",
								["action"] = "epidemic",
							}, -- [3]
							{
						...
						["generic"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "cooldown.apocalypse.remains & ( talent.defile.enabled || covenant.night_fae )",
								["action"] = "any_dnd",
							}, -- [3]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "debuff.festering_wound.up & cooldown.apocalypse.remains > 5 & ( ! talent.unholy_blight.enabled || talent.army_of_the_damned.enabled || conduit.convocation_of_the_dead.enabled || raid_event.adds.exists )",
								["action"] = "wound_spender",
							}, -- [5]
							{
								["enabled"] = true,
								["criteria"] = "debuff.festering_wound.up & talent.unholy_blight.enabled & ! talent.army_of_the_damned.enabled & ! conduit.convocation_of_the_dead.enabled & ! raid_event.adds.exists & ( cooldown.unholy_blight.remains > 5 & cooldown.apocalypse.ready & ! dot.unholy_blight.remains || ! cooldown.apocalypse.ready )",
								["action"] = "wound_spender",
							}, -- [6]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "debuff.festering_wound.stack < 4 & cooldown.apocalypse.remains < 3 & ( ! talent.unholy_blight.enabled || talent.army_of_the_damned.enabled || conduit.convocation_of_the_dead.enabled || raid_event.adds.exists )",
								["action"] = "festering_strike",
							}, -- [9]
							{
								["enabled"] = true,
								["criteria"] = "debuff.festering_wound.stack < 4 & talent.unholy_blight.enabled & ! talent.army_of_the_damned.enabled & ! conduit.convocation_of_the_dead.enabled & ! raid_event.adds.exists & cooldown.apocalypse.ready & ( cooldown.unholy_blight.remains < 3 || dot.unholy_blight.remains )",
								["action"] = "festering_strike",
							}, -- [10]
							{
								["enabled"] = true,
						...
						["covenants"] = {
							{
								["enabled"] = true,
								["criteria"] = "variable.st_planning & runic_power.deficit > 6",
								["action"] = "swarming_mist",
							}, -- [1]
							{
								["enabled"] = true,
								["criteria"] = "active_enemies >= 2 & active_enemies <= 5 & runic_power.deficit > ( active_enemies * 6 ) || active_enemies > 5 & runic_power.deficit > 30",
								["action"] = "swarming_mist",
							}, -- [2]
							{
								["enabled"] = true,
								["criteria"] = "variable.st_planning & rune.time_to_4 > ( 3 + buff.runic_corruption.remains )",
							...
							{
								["enabled"] = true,
								["criteria"] = "variable.st_planning & cooldown.apocalypse.remains",
						...
						["cooldowns"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "pet.gargoyle.active || buff.unholy_assault.up || talent.army_of_the_damned.enabled & ( pet.army_ghoul.active || pet.apoc_ghoul.active || cooldown.army_of_the_dead.remains > target.time_to_die )",
								["action"] = "potion",
							}, -- [2]
							{
								["enabled"] = true,
								["criteria"] = "cooldown.unholy_blight.remains < 5 & talent.unholy_blight.enabled || ! talent.unholy_blight.enabled",
								["action"] = "army_of_the_dead",
							}, -- [3]
							{
								["enabled"] = true,
								["criteria"] = "variable.st_planning & ( cooldown.army_of_the_dead.remains > 5 || death_knight.disable_aotd ) & ( cooldown.apocalypse.ready & ( debuff.festering_wound.stack >= 4 || rune >= 3 ) || cooldown.apocalypse.remains )",
							...
							{
								["enabled"] = true,
								["criteria"] = "variable.st_planning & cooldown.unholy_blight.remains & ( ! runeforge.deadliest_coil.enabled || runeforge.deadliest_coil.enabled & ( ! buff.dark_transformation.up & ! talent.unholy_pact.enabled || talent.unholy_pact.enabled ) )",
								["action"] = "dark_transformation",
							}, -- [6]
							{
								["enabled"] = true,
								["criteria"] = "variable.st_planning & ! talent.unholy_blight.enabled",
								["action"] = "dark_transformation",
							}, -- [7]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "active_enemies = 1 & debuff.festering_wound.stack >= 4 & ( ( ! talent.unholy_blight.enabled || talent.army_of_the_damned.enabled || conduit.convocation_of_the_dead.enabled ) || talent.unholy_blight.enabled & ! talent.army_of_the_damned.enabled & dot.unholy_blight.remains )",
								["action"] = "apocalypse",
							}, -- [9]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "variable.st_planning & debuff.festering_wound.stack < 2 & ( pet.apoc_ghoul.active || conduit.convocation_of_the_dead.enabled )",
						...
						["aoe_setup"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "! variable.pooling_for_gargoyle & runic_power.deficit < 20 || buff.sudden_doom.react",
								["action"] = "epidemic",
							}, -- [3]
							{
								["enabled"] = true,
						...
						["default"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "pet.gargoyle.active || buff.unholy_assault.up || talent.army_of_the_damned.enabled & ( pet.army_ghoul.active || cooldown.army_of_the_dead.remains > target.time_to_die || pet.apoc_ghoul.active & cooldown.army_of_the_dead.remains > cooldown.blood_fury.duration )",
								["action"] = "blood_fury",
							}, -- [5]
							{
								["enabled"] = true,
								["criteria"] = "pet.gargoyle.active || buff.unholy_assault.up || talent.army_of_the_damned.enabled & ( pet.army_ghoul.active || cooldown.army_of_the_dead.remains > target.time_to_die || pet.apoc_ghoul.active & cooldown.army_of_the_dead.remains > cooldown.berserking.duration )",
								["action"] = "berserking",
							}, -- [6]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "pet.gargoyle.active || buff.unholy_assault.up || talent.army_of_the_damned.enabled & ( pet.army_ghoul.active || cooldown.army_of_the_dead.remains > target.time_to_die || pet.apoc_ghoul.active & cooldown.army_of_the_dead.remains > cooldown.ancestral_call.duration )",
								["action"] = "ancestral_call",
							}, -- [8]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "pet.gargoyle.active || buff.unholy_assault.up || talent.army_of_the_damned.enabled & ( pet.army_ghoul.active || cooldown.army_of_the_dead.remains > target.time_to_die || pet.apoc_ghoul.active & cooldown.army_of_the_dead.remains > cooldown.fireblood.duration )",
								["action"] = "fireblood",
							}, -- [10]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "dot.virulent_plague.refreshable & ( ! talent.unholy_blight.enabled || talent.unholy_blight.enabled & cooldown.unholy_blight.remains ) & active_enemies >= 2",
								["action"] = "outbreak",
							}, -- [28]
							{
								["enabled"] = true,
				...
				["Frost DK"] = {
					...
					["lists"] = {
						["essences"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.pillar_of_frost.up || buff.empower_rune_weapon.up || cooldown.breath_of_sindragosa.remains > 60 + 15 || equipped.ineffable_truth || equipped.ineffable_truth_oh",
								["action"] = "worldvein_resonance",
							}, -- [8]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "target.health_pct > 80 || target.health_pct < 20 || fight_remains < 5",
								["action"] = "reaping_flames",
							}, -- [11]
						},
						["obliteration"] = {
							{
								["enabled"] = true,
								["criteria"] = "talent.gathering_storm.enabled & active_enemies >= 3",
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.killing_machine.react & spell_targets.frostscythe >= 2 & ( ! death_and_decay.ticking & covenant.night_fae || ! covenant.night_fae )",
								["action"] = "frostscythe",
							}, -- [3]
							{
								["enabled"] = true,
							...
							}, -- [8]
							{
								["enabled"] = true,
								["action"] = "frost_strike",
								["criteria"] = "runic_power.deficit < 10 || rune.time_to_2 > gcd || ! buff.rime.up",
								["cycle_targets"] = 1,
							}, -- [9]
							{
								["enabled"] = true,
						...
						["bos_ticking"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "talent.gathering_storm.enabled || active_enemies >= 2",
								["action"] = "remorseless_winter",
							}, -- [2]
							{
								["enabled"] = true,
							...
							}, -- [3]
							{
								["enabled"] = true,
								["action"] = "obliterate",
								["criteria"] = "rune.time_to_4 < gcd || runic_power <= 45",
								["cycle_targets"] = 1,
							}, -- [4]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "spell_targets.frostscythe >= 2 & ( ! death_and_decay.ticking & covenant.night_fae || ! covenant.night_fae )",
								["action"] = "frostscythe",
							}, -- [7]
							{
								["enabled"] = true,
						...
						["cooldowns"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "active_enemies >= 2 & cooldown.pillar_of_frost.remains + 15 > target.time_to_die || fight_remains < gcd",
								["action"] = "frostwyrms_fury",
							}, -- [18]
							{
								["enabled"] = true,
						...
						["aoe"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.killing_machine.up & ( ! death_and_decay.ticking & covenant.night_fae || ! covenant.night_fae )",
								["action"] = "frostscythe",
							}, -- [5]
							{
								["enabled"] = true,
						...
						["bos_pooling"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "talent.gathering_storm.enabled & rune >= 5 || active_enemies >= 2",
								["action"] = "remorseless_winter",
							}, -- [2]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.killing_machine.up & runic_power.deficit > ( 15 + talent.runic_attenuation.enabled * 3 ) & spell_targets.frostscythe >= 2 & ( ! death_and_decay.ticking & covenant.night_fae || ! covenant.night_fae )",
								["action"] = "frostscythe",
							}, -- [6]
							{
								["enabled"] = true,
								["criteria"] = "runic_power.deficit >= ( 35 + talent.runic_attenuation.enabled * 3 ) & spell_targets.frostscythe >= 2 & ( ! death_and_decay.ticking & covenant.night_fae || ! covenant.night_fae )",
								["action"] = "frostscythe",
							}, -- [7]
							{
								["enabled"] = true,
						...
						["standard"] = {
							{
								["enabled"] = true,
								["criteria"] = "talent.gathering_storm.enabled || conduit.everfrost.enabled || runeforge.biting_cold",
								["action"] = "remorseless_winter",
							}, -- [1]
							{
								["enabled"] = true,
					...
					["lists"] = {
						["opener"] = {
							...
							}, -- [15]
							{
								...
								["chain"] = "1",
								["criteria"] = "debuff.touch_of_the_magi.up & talent.arcane_echo.enabled & buff.deathborne.down & debuff.touch_of_the_magi.remains > action.arcane_missiles.execute_time & ( ! azerite.arcane_pummeling.enabled || buff.clearcasting_channel.down )",
							}, -- [16]
							{
								["enabled"] = true,
								["action"] = "arcane_missiles",
						...
						["essences"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "cooldown.arcane_power.remains = 0 & ( ! talent.enlightened.enabled || ( talent.enlightened.enabled & mana.pct >= 70 || settings.am_spam = 1 ) ) & ( ( cooldown.touch_of_the_magi.remains > variable.ap_max_delay & ( buff.arcane_charge.stack = buff.arcane_charge.max_stack || settings.am_spam = 1 ) ) || ( cooldown.touch_of_the_magi.remains = 0 & buff.arcane_charge.stack = 0 ) ) & buff.rune_of_power.down & mana.pct >= variable.ap_minimum_mana_pct",
								["action"] = "blood_of_the_enemy",
							}, -- [2]
							{
								["enabled"] = true,
						...
						["rotation"] = {
							...
							}, -- [7]
							{
								...
								["action"] = "arcane_missiles",
								["chain"] = "1",
								["criteria"] = "debuff.touch_of_the_magi.up & talent.arcane_echo.enabled & buff.deathborne.down & ( debuff.touch_of_the_magi.remains > action.arcane_missiles.execute_time || cooldown.presence_of_mind.remains > 0 || covenant.kyrian ) & ( ! azerite.arcane_pummeling.enabled || buff.clearcasting_channel.down )",
							}, -- [8]
							{
								["enabled"] = true,
						...
						["am_spam"] = {
							{
								["enabled"] = true,
								["criteria"] = "mana.pct <= variable.am_spam_evo_pct & ( cooldown.touch_of_the_magi.remains <= action.evocation.execute_time || cooldown.arcane_power.remains <= action.evocation.execute_time || ( talent.rune_of_power.enabled & cooldown.rune_of_power.remains <= action.evocation.execute_time ) ) & buff.rune_of_power.down & buff.arcane_power.down & debuff.touch_of_the_magi.down",
						...
						["precombat"] = {
							...
							}, -- [23]
							{
								...
								["action"] = "variable",
								["value"] = "1",
								["criteria"] = "variable.have_opened = 0 & settings.am_spam = 1",
								["var_name"] = "have_opened",
							}, -- [24]
							{
								["enabled"] = true,
				...
				["Retribution"] = {
					...
					["lists"] = {
						...
						["finishers"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "( ! talent.crusade.enabled || cooldown.crusade.remains > gcd * 3 ) & ( ! talent.execution_sentence.enabled || cooldown.execution_sentence.remains > gcd * 3 & spell_targets.divine_storm <= 3 ) & ( ! covenant.necrolord || cooldown.vanquishers_hammer.remains > gcd ) || talent.holy_avenger.enabled & cooldown.holy_avenger.remains < gcd * 3 || buff.holy_avenger.up || buff.crusade.up & buff.crusade.stack < 10 || buff.vanquishers_hammer.up",
				...
				["Discipline"] = {
					...
					["lists"] = {
						["default"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.bloodlust.react || target.time_to_die <= 40",
								["action"] = "potion",
							}, -- [2]
							{
								["enabled"] = true,
								["criteria"] = "talent.mindbender.enabled & mana.pct < 80",
								["action"] = "mindbender",
							}, -- [3]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "! ticking & ! talent.purge_the_wicked.enabled",
								["action"] = "shadow_word_pain",
							}, -- [13]
							{
								["action"] = "schism",
							...
							{
								["enabled"] = true,
								["criteria"] = "remains < ( duration * 0.3 ) & ! talent.purge_the_wicked.enabled",
								["action"] = "shadow_word_pain",
							}, -- [17]
							{
					...
					["profile"] = "priest=\"Ririchíyo\"\nsource=default\nspec=discipline\nlevel=120\nrace=lightforged_draenei\nrole=spell\nposition=back\nprofessions=tailoring=151/enchanting=175\ntalents=3333113\nazerite_essences=17:3/300573/27:3/300575/300576/19:3/300577/312927/37:3/312928\n\n# Default consumables\npotion=potion_of_unbridled_fury\nflask=greater_flask_of_endless_fathoms\nfood=baked_port_tato\naugmentation=battle_scarred\n\n# This default action priority list is automatically created based on your character.\n# It is a attempt to provide you with a action list that is both simple and practicable,\n# while resulting in a meaningful and good simulation. It may not result in the absolutely highest possible dps.\n# Feel free to edit, adapt and improve it to your own needs.\n# SimulationCraft is always looking for updates and improvements to the default action lists.\n\n# Executed before combat begins. Accepts non-harmful actions only.\nactions.precombat=flask\nactions.precombat+=/food\nactions.precombat+=/augmentation\n# Snapshot raid buffed stats before combat begins and pre-potting is done.\nactions.precombat+=/snapshot_stats\n\n# Executed every time the actor is available.\nactions=use_item,slot=trinket2\nactions+=/potion,if=buff.bloodlust.react||target.time_to_die<=40\nactions+=/mindbender,if=talent.mindbender.enabled\nactions+=/shadowfiend,if=!talent.mindbender.enabled\nactions+=/blood_fury\nactions+=/berserking\nactions+=/arcane_torrent\nactions+=/lights_judgment\nactions+=/fireblood\nactions+=/ancestral_call\nactions+=/bag_of_tricks\nactions+=/purge_the_wicked,if=!ticking\nactions+=/shadow_word_pain,if=!ticking&!talent.purge_the_wicked.enabled\nactions+=/schism\nactions+=/penance\nactions+=/purge_the_wicked,if=remains<(duration*0.3)\nactions+=/shadow_word_pain,if=remains<(duration*0.3)&!talent.purge_the_wicked.enabled\nactions+=/power_word_solace\nactions+=/divine_star,if=mana.pct>80\nactions+=/smite\nactions+=/shadow_word_pain\n\nhead=visage_of_nightmarish_machinations,id=174118,bonus_id=4823/1502/4786/6508/4775,azerite_powers=404/582/102/83/13\nneck=heart_of_azeroth,id=158075,bonus_id=6316/4932/4933/1646,azerite_level=88\nshoulders=spaulders_of_miasmic_mycelia,id=174117,bonus_id=4823/1502/4786/6509/4775,azerite_powers=399/582/104/204/13\nback=ashjrakamas_shroud_of_resolve,id=169223,bonus_id=6582/1472\nchest=robes_of_unreality,id=174119,bonus_id=4824/1517/4786/6510/4775,azerite_powers=227/582/38/83/13\nwrists=voiddrenched_wristwraps,id=174122,bonus_id=4824/6515/1517/4786/6482/6470\nhands=greasy_bacongrabbers,id=155891,bonus_id=6536/41/6578/6513/1647/4786/6516\nwaist=ouroborial_sash,id=159255,bonus_id=6536/6578/6579/6560/6513/1647/4786\nlegs=darklight_legwarmers,id=159269,bonus_id=6534/6578/6579/6476/6470/6515/1642/4786\nfeet=hyperthread_boots,id=168964,bonus_id=6536/6578/6513/1532/4786/6475/6462\nfinger1=lurking_schemers_band,id=175008,bonus_id=4824/6515/1517/4786/6475/6462,gem_id=168641,enchant_id=6109\nfinger2=seal_of_the_regal_loa,id=159458,bonus_id=6536/6578/6515/1647/4786/6516,enchant_id=6109\ntrinket1=humming_black_dragonscale,id=174044,bonus_id=4824/6513/1517/4786\ntrinket2=forbidden_obsidian_claw,id=173944,bonus_id=4824/1808/6513/1517/4786,gem_id=168641\nmain_hand=bloodstained_ritual_athame,id=172201,bonus_id=4824/6515/1517/4786/6516,enchant_id=5963\noff_hand=zealous_ritualists_reverie,id=175009,bonus_id=4824/41/6578/6513/1517/4786/6516\n\n# Gear Summary\n# gear_ilvl=478.69\n# gear_stamina=20746\n# gear_intellect=12859\n# gear_crit_rating=1319\n# gear_haste_rating=1733\n# gear_mastery_rating=800\n# gear_versatility_rating=519\n# gear_leech_rating=180\n# gear_corruption=105\n# gear_corruption_resistance=62\n# gear_armor=2296",
				},
				["Elemental"] = {
					["source"] = "https://github.com/simulationcraft/simc/",
					["builtIn"] = true,
					...
					["lists"] = {
						...
						["se_single_target"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "spell_targets.chain_lightning < 2 & maelstrom >= 60 & ( buff.wind_gust.stack < 20 || maelstrom > 90 )",
								["action"] = "earth_shock",
							}, -- [9]
							{
								["enabled"] = true,
					...
					["lists"] = {
						...
						["stealth"] = {
							...
							}, -- [1]
							{
								["enabled"] = true,
								["action"] = "rake",
								["criteria"] = "dot.rake.pmultiplier < 1.5 & druid.rake.ticks_gained_on_refresh > 2",
								["cycle_targets"] = 1,
							}, -- [2]
							{
								["enabled"] = true,
								["criteria"] = "level < 54 & azerite.wild_fleshrending.enabled & ! dot.thrash_cat.ticking",
								["action"] = "thrash_cat",
							}, -- [3]
							{
								["enabled"] = true,
								["criteria"] = "level < 54 & spell_targets.brutal_slash * action.brutal_slash.damage > action.shred.damage",
								["action"] = "brutal_slash",
							}, -- [4]
							{
								["enabled"] = true,
								["criteria"] = "level < 54 & spell_targets.swipe_cat * action.swipe_cat.damage > action.shred.damage",
								["action"] = "swipe_cat",
							}, -- [5]
							{
								["action"] = "shred",
						...
						["cooldown"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "energy.deficit > 55 || ( buff.bs_inc.up & buff.bs_inc.remains < 13 ) || ( talent.predator.enabled & shortest_ttd < 3 )",
								["action"] = "tigers_fury",
							}, -- [3]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "( dot.rip.remains > 4 & ( buff.tigers_fury.down || buff.tigers_fury.remains < 4 ) & combo_points = 0 & dot.thrash_cat.ticking & dot.rake.ticking ) || fight_remains < 5",
				...
				["Enhancement"] = {
					...
					["lists"] = {
						["aoe"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "runeforge.doom_winds.equipped & buff.doom_winds_debuff.down",
					...
					["lists"] = {
						["default"] = {
							...
							}, -- [19]
							{
								...
								["op"] = "set",
								["action"] = "variable",
								["value"] = "! variable.disable_combustion & variable.time_to_combustion < action.fire_blast.full_recharge_time - variable.shifting_power_reduction * ( cooldown.shifting_power.remains < variable.time_to_combustion ) & variable.time_to_combustion < fight_remains",
							...
							}, -- [20]
							{
								...
								["op"] = "set",
								["action"] = "variable",
								["value"] = "! variable.disable_combustion & variable.time_to_combustion < action.phoenix_flames.full_recharge_time - variable.shifting_power_reduction * ( cooldown.shifting_power.remains < variable.time_to_combustion ) & variable.time_to_combustion < fight_remains || runeforge.sun_kings_blessing.equipped",
						...
						["precombat"] = {
							...
							}, -- [8]
							{
								...
								["op"] = "set",
								["action"] = "variable",
								["value"] = "- action.shifting_power.execute_time / action.shifting_power.cdr",
				...
				["Vengeance"] = {
					...
					["lists"] = {
						["brand"] = {
							{
								["enabled"] = true,
								["criteria"] = "! runeforge.razelikhs_defilement.equipped & cooldown.fiery_brand.remains < 2",
							...
							{
								["enabled"] = true,
								["criteria"] = "! runeforge.razelikhs_defilement.equipped & dot.fiery_brand.ticking",
								["action"] = "sigil_of_flame",
							}, -- [6]
						},
						["default"] = {
						...
						["normal"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "! runeforge.razelikhs_defilement.equipped",
								["action"] = "sigil_of_flame",
							}, -- [10]
							{
								["action"] = "shear",
					...
					["lists"] = {
						["boat"] = {
							...
							}, -- [2]
							{
								["enabled"] = true,
								["action"] = "adaptive_swarm",
								["criteria"] = "buff.balance_of_all_things_nature.stack_value < 40 & buff.balance_of_all_things_arcane.stack_value < 40 & ( ! dot.adaptive_swarm_damage.ticking & ! action.adaptive_swarm_damage.in_flight & ( ! dot.adaptive_swarm_heal.ticking || dot.adaptive_swarm_heal.remains > 3 ) || dot.adaptive_swarm_damage.stack < 3 & dot.adaptive_swarm_damage.remains < 5 & dot.adaptive_swarm_damage.ticking )",
								["cycle_targets"] = 1,
							}, -- [3]
							{
								["enabled"] = true,
								["criteria"] = "( variable.convoke_desync & ! cooldown.ca_inc.ready || buff.ca_inc.up ) & ( buff.balance_of_all_things_nature.stack_value = 50 || buff.balance_of_all_things_arcane.stack_value = 50 ) || fight_remains < 10",
								["action"] = "convoke_the_spirits",
							}, -- [4]
							{
								["enabled"] = true,
						...
						["aoe"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "( variable.convoke_desync & ! cooldown.ca_inc.ready || buff.ca_inc.up ) & astral_power < 50 & ( buff.eclipse_lunar.remains > 6 || buff.eclipse_solar.remains > 6 ) & ( ! runeforge.balance_of_all_things.enabled || buff.balance_of_all_things_nature.stack_value > 30 || buff.balance_of_all_things_arcane.stack_value > 30 ) || fight_remains < 10",
								["action"] = "convoke_the_spirits",
							}, -- [2]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "variable.dream_will_fall_off & variable.starfall_wont_fall_off || ( buff.balance_of_all_things_nature.stack_value > 30 || buff.balance_of_all_things_arcane.stack_value > 30 ) & spell_targets.starfall < 4",
								["action"] = "starsurge",
							}, -- [6]
							{
								["enabled"] = true,
				...
				["Demonology"] = {
					...
					["lists"] = {
						...
						["default"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "active_enemies > 1 & ! talent.sacrificed_souls.enabled & buff.wild_imps.stack >= settings.implosion_imps & buff.tyrant.down & cooldown.summon_demonic_tyrant.remains > 5",
								["action"] = "implosion",
							}, -- [13]
							{
								["enabled"] = true,
								["criteria"] = "active_enemies > 2 & buff.wild_imps.stack >= settings.implosion_imps & buff.tyrant.down",
								["action"] = "implosion",
							}, -- [14]
							{
								["enabled"] = true,
						...
						["summon_tyrant"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "! talent.demonic_consumption.enabled || buff.wild_imps.stack > 5",
				...
				["Affliction"] = {
					...
					["lists"] = {
						...
						["default"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "covenant.necrolord || covenant.night_fae || covenant.kyrian || covenant.none",
								["action"] = "phantom_singularity",
							}, -- [19]
							{
								["enabled"] = true,
							...
							}, -- [23]
							{
								...
								["action"] = "call_action_list",
								["strict"] = 1,
								["criteria"] = "debuff.shadow_embrace.stack < ( 2 - action.shadow_bolt.in_flight ) || debuff.shadow_embrace.remains < 3",
								["list_name"] = "se",
							}, -- [24]
							{
								["enabled"] = true,
								["criteria"] = "dot.impending_catastrophe_dot.ticking",
								["action"] = "malefic_rapture",
							}, -- [25]
							{
								["enabled"] = true,
								["criteria"] = "dot.soul_rot.ticking",
								["action"] = "malefic_rapture",
							}, -- [26]
							{
								["enabled"] = true,
								["criteria"] = "talent.phantom_singularity.enabled & ( dot.phantom_singularity.ticking || soul_shard > 3 || time_to_die < cooldown.phantom_singularity.remains )",
								["action"] = "malefic_rapture",
							}, -- [27]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.inevitable_demise.stack > 40 || buff.inevitable_demise.up & time_to_die < 4",
								["action"] = "drain_life",
							}, -- [29]
							{
								["enabled"] = true,
						...
						["aoe"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "active_dot.siphon_life <= 3 & ! dot.siphon_life.ticking",
								["action"] = "siphon_life",
								["cycle_targets"] = 1,
							}, -- [19]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.inevitable_demise.stack >= 50 || buff.inevitable_demise.up & time_to_die < 5 || buff.inevitable_demise.stack >= 35 & dot.soul_rot.ticking",
								["action"] = "drain_life",
							}, -- [21]
							{
								["interrupt"] = "1",
					...
					["lists"] = {
						...
						["default"] = {
							...
							}, -- [11]
							{
								...
								["name"] = "azsharas_font_of_power",
								["action"] = "azsharas_font_of_power",
								["criteria"] = "( cooldown.dancing_rune_weapon.remains < 5 & fight_remains > 15 ) || ( fight_remains < 34 )",
							}, -- [12]
							{
								["enabled"] = true,
								["name"] = "merekthas_fang",
						...
						["covenants"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "( ! covenant.night_fae || buff.deaths_due.remains > 6 ) & ! buff.dancing_rune_weapon.up & ( pet.ghoul.remains < 10 || fight_remains < gcd )",
								["action"] = "sacrificial_pact",
							}, -- [4]
							{
								["enabled"] = true,
				...
				["Protection Paladin"] = {
					...
					["lists"] = {
						...
						["standard"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.shining_light_free.up & ! covenant.necrolord",
								["action"] = "word_of_glory",
							}, -- [23]
						},
					},
				...
				["Mistweaver"] = {
					["date"] = 20200826.102659,
					["profile"] = "monk=\"Akatsúki\"\nsource=default\nspec=mistweaver\nlevel=120\nrace=night_elf\ntimeofday=day\nrole=attack\nposition=back\nprofessions=leatherworking=175/skinning=160\ntalents=1233233\nazerite_essences=32:2/300573/24:3/300575/300576/27:3/300577/312927/17:3/312928\n\n# Default consumables\npotion=potion_of_unbridled_fury\nflask=greater_flask_of_endless_fathoms\nfood=baked_port_tato\naugmentation=battle_scarred\n\n# This default action priority list is automatically created based on your character.\n# It is a attempt to provide you with a action list that is both simple and practicable,\n# while resulting in a meaningful and good simulation. It may not result in the absolutely highest possible dps.\n# Feel free to edit, adapt and improve it to your own needs.\n# SimulationCraft is always looking for updates and improvements to the default action lists.\n\n# Executed before combat begins. Accepts non-harmful actions only.\nactions.precombat=flask\nactions.precombat+=/food\nactions.precombat+=/augmentation\n# Snapshot raid buffed stats before combat begins and pre-potting is done.\nactions.precombat+=/snapshot_stats\nactions.precombat+=/potion\nactions.precombat+=/chi_burst\nactions.precombat+=/chi_wave\n\n# Executed every time the actor is available.\nactions=auto_attack\nactions+=/use_item,name=manifesto_of_madness\nactions+=/use_item,name=forbidden_obsidian_claw\nactions+=/use_item,name=neural_synapse_enhancer\nactions+=/blood_fury,if=target.time_to_die<18\nactions+=/berserking,if=target.time_to_die<18\nactions+=/arcane_torrent,if=chi.max-chi>=1&target.time_to_die<18\nactions+=/lights_judgment,if=target.time_to_die<18\nactions+=/fireblood,if=target.time_to_die<18\nactions+=/ancestral_call,if=target.time_to_die<18\nactions+=/bag_of_tricks,if=target.time_to_die<18\nactions+=/potion\nactions+=/run_action_list,name=aoe,if=active_enemies>=4\nactions+=/call_action_list,name=st,if=active_enemies<4\n\nactions.aoe=spinning_crane_kick\nactions.aoe+=/chi_wave\nactions.aoe+=/chi_burst\n\nactions.st=rising_sun_kick\nactions.st+=/blackout_kick,if=buff.teachings_of_the_monastery.stack=1&cooldown.rising_sun_kick.remains<12\nactions.st+=/chi_wave\nactions.st+=/chi_burst\nactions.st+=/tiger_palm,if=buff.teachings_of_the_monastery.stack<3||buff.teachings_of_the_monastery.remains<2\n\nhead=cowl_of_fluid_machinations,id=159302,bonus_id=5445/1632/4786/6508/4775,azerite_powers=248/185/463/85/13\nneck=heart_of_azeroth,id=158075,bonus_id=6316/4932/4933/1642,azerite_level=86\nshoulders=spaulders_of_aberrant_allure,id=174135,bonus_id=4823/1502/4786/6509/4775,azerite_powers=386/248/102/14/13\nback=ashjrakamas_shroud_of_resolve,id=169223,bonus_id=6280/1472\nchest=goresplattered_vest,id=159330,bonus_id=5445/1632/4786/6507/4775,azerite_powers=248/386/38/83/13\nshirt=common_white_shirt,id=167179\nwrists=blood_elders_bindings,id=159324,bonus_id=6536/6578/6579/6485/6461/6513/1647/4786\nhands=gloves_of_corrupted_waters,id=159321,bonus_id=5010/4802/6578/6515/1637/4786/6516,gem_id=168639\nwaist=mekgineers_championship_belt,id=168957,bonus_id=6530/6578/6515/1527/4786/6516\nlegs=leggings_of_the_galeforce_viper,id=159329,bonus_id=6532/6578/6579/6564/6513/1642/4786\nfeet=machinists_treasured_treads,id=168975,bonus_id=6536/6578/6515/1532/4786/6516\nfinger1=murky_cerulean_signet,id=158318,bonus_id=6532/6516/6513/1632/4786,enchant_id=6109\nfinger2=overseers_lost_seal,id=159460,bonus_id=6536/6578/6515/1647/4786/6482/6470\ntrinket1=manifesto_of_madness,id=174103,bonus_id=4823/6515/1502/4786\ntrinket2=forbidden_obsidian_claw,id=173944,bonus_id=4823/6513/1502/4786\nmain_hand=neural_synapse_enhancer,id=168973,bonus_id=6532/6516/6513/1517/4786,enchant_id=6112\n\n# Gear Summary\n# gear_ilvl=471.07\n# gear_stamina=18863\n# gear_intellect=10819\n# gear_crit_rating=1277\n# gear_haste_rating=910\n# gear_mastery_rating=1303\n# gear_versatility_rating=686\n# gear_corruption=71\n# gear_corruption_resistance=35\n# gear_armor=3523",
					...
					["lists"] = {
						...
						["default"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "chi.max - chi >= 1 & target.time_to_die < 18",
								["action"] = "arcane_torrent",
							}, -- [7]
							{
								["enabled"] = true,
						...
						["st"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.teachings_of_the_monastery.stack = 1 & cooldown.rising_sun_kick.remains < 12",
								["action"] = "blackout_kick",
							}, -- [2]
							{
								["action"] = "chi_wave",
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.teachings_of_the_monastery.stack < 3 || buff.teachings_of_the_monastery.remains < 2",
								["action"] = "tiger_palm",
							}, -- [5]
						},
						["precombat"] = {
