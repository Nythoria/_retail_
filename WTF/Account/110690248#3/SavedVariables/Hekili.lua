				...
				["Frost Mage"] = {
					...
					["lists"] = {
						...
						["st"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.freezing_rain.up & ! settings.ignore_freezing_rain_st || active_enemies >= 2 || runeforge.glacial_fragments.enabled & remaining_winters_chill = 2",
								["action"] = "blizzard",
							}, -- [3]
							{
								["enabled"] = true,
					...
					["lists"] = {
						...
						["default"] = {
							...
							}, -- [3]
							{
								...
								["description"] = "Delay Combustion for Gladiator's Badge.",
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.combustion.down & ! ( buff.infernal_cascade.up & buff.hot_streak.react ) & variable.shifting_power_before_combustion",
								["action"] = "shifting_power",
							}, -- [9]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.rune_of_power.down & ! buff.firestorm.react & ( variable.time_to_combustion >= buff.rune_of_power.duration & variable.time_to_combustion > action.fire_blast.full_recharge_time || variable.time_to_combustion > fight_remains )",
								["action"] = "rune_of_power",
							}, -- [26]
							{
								["enabled"] = true,
							...
							}, -- [27]
							{
								...
								["description"] = "Variable that controls Phoenix Flames usage to ensure its charges are pooled for Combustion.",
						...
						["combustion_phase"] = {
							...
							}, -- [5]
							{
								["enabled"] = true,
								["use_while_casting"] = 1,
								["criteria"] = "! conduit.infernal_cascade.enabled & charges >= 1 & buff.combustion.up & ! buff.firestorm.react & ! buff.hot_streak.react & hot_streak_spells_in_flight + buff.heating_up.react < 2",
								["use_off_gcd"] = 1,
								["action"] = "fire_blast",
							...
							{
								["enabled"] = true,
								["criteria"] = "( buff.hot_streak.react & active_enemies >= variable.combustion_flamestrike ) || ( buff.firestorm.react & active_enemies >= variable.combustion_flamestrike - runeforge.firestorm.enabled )",
								["action"] = "flamestrike",
							}, -- [17]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.pyroclasm.react & buff.pyroclasm.remains > cast_time & ( buff.combustion.remains > cast_time || buff.combustion.down ) & active_enemies < variable.combustion_flamestrike",
								["action"] = "pyroblast",
							}, -- [20]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "prev_gcd.1.scorch & buff.heating_up.react & active_enemies < variable.combustion_flamestrike",
								["action"] = "pyroblast",
							}, -- [22]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.combustion.up & travel_time < buff.combustion.remains & ( ( action.fire_blast.charges < 1 & talent.pyroclasm.enabled & active_enemies = 1 ) || ! talent.pyroclasm.enabled || active_enemies > 1 ) & buff.heating_up.react + hot_streak_spells_in_flight < 2",
								["action"] = "phoenix_flames",
							}, -- [24]
							{
								["enabled"] = true,
